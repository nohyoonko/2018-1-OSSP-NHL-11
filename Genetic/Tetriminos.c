...
Tetrimino* createTetrimino(short type) {
    ...
    switch(type) {
        ...
        break;
           ...
           //추가
            case TETRI_P: //+ 블록
                rotateP(tetrimino, ROT_0);
                break;

            case TETRI_N: //. 블록
                rotateN(tetrimino, ROT_0);
                break;

            case TETRI_M: //작은 ㄱ 블록
                rotateM(tetrimino, ROT_0);
                break;
...
/**
 * Rotates a P Tetrimino (+)
 * */
void rotateP(Tetrimino* tetrimino, short rotation) {
    switch (rotation) {
    case ROT_0:
    case ROT_1:
    case ROT_2:
...
/**
 * Rotates a N Tetrimino (.)
 * */
void rotateN(Tetrimino* tetrimino, short rotation) {
    switch (rotation) {
    case ROT_0:
    case ROT_1:
    case ROT_2:
...
/**
 * Rotates a M Tetrimino (ㄱ)
 * */
void rotateM(Tetrimino* tetrimino, short rotation) {
    switch (rotation) {
    case ROT_0:
        tetrimino->array[3][1] = 1;
        tetrimino->array[2][0] = 1;
